...
class DepartmentsController extends AppController {
	...
	function admin_add() {
		if (!empty($this->data)) {
			...
			if ($this->Department->save($this->data)) {
				$this->Session->setFlash(__('The department has been added successfully.', true), 'default', array('class' => 'success'));
	...
	function admin_edit($id = null) {
		...
		if (!empty($this->data)) {
			if ($this->Department->save($this->data)) {
				$this->Session->setFlash(__('The department has been updated successfully.', true), 'default', array('class' => 'success'));
				$this->redirect(array('action'=>'index'));
			} else {
	...
	function admin_delete($id = null) {
		...
		if ($this->Department->delete($id)) {
			$this->Session->setFlash(__('The department was successfully deleted.', true), 'default', array('class' => 'success'));
			$this->redirect(array('action'=>'index'));
		}
	}
}
