...
<?php echo $form->create('Product');?>
	<fieldset>
		...
		<?php
			...
			echo $form->input('status_id', array('label' => 'Payment Status', 'empty' => 'Default', 'after' => '<p style="padding-top:10px;"> The status the auction will be updated to after the payment has been made. </p>','class' => 'form-control', 'div' => array('class' => 'col-md-offset-4 col-sm-offset-4 col-sm-4 col-md-4')));
			...
			echo $form->input('delivery_cost', array('class' => 'form-control', 'div' => array('class' => 'col-md-offset-4 col-sm-offset-4 col-sm-4 col-md-4')));
			echo $form->input('delivery_information', array('class' => 'form-control', 'div' => array('class' => 'col-md-offset-4 col-sm-offset-4 col-sm-4 col-md-4')));
