...
<div class="slider-pro" id="my-slider">
	...
	<ul class="nav nav-tabs nav-justified m-none">
		<li><a href="/">Home</a></li>
		<li class="menuactive"><a href="/auctions">Live Auctions</a></li>
	...
	<ul class="nav nav-tabs nav-justified d-none" style="border-bottom: 2px solid #08afd8;border-top: 2px solid #08afd8;     margin-top: 5px; background-color:#08afd8; border-radius:0;">
		<div class="col-xs-4" style="width:20%; text-align:center; font-size: 18px;"><li class="a-active" style="padding:5px 0 3px 0; text-align:right;"><a href="/auctions" style="color:#fff;">Live</a></li></div>
