...
<ul class="nav navbar-nav navbar-right d-none">
	...
	<div class="row text-center">
		...
		<div class="row" style="padding-bottom: 25px;">
			...
			<div class="col-xs-3"><a href="/users" style="color:#fff;padding:10px 0;"><span class="glyphicon glyphicon-dashboard" aria-hidden="true" style="font-size:20px;"></span><p style="font-size:13px;">Dashboard</p></a></div>
			<div class="col-xs-3"><a href="/watchlists" style="color:#fff;padding:10px 0;"><span class="glyphicon glyphicon-eye-open" aria-hidden="true" style="font-size:20px;"></span><p style="font-size:13px;">Watchlist</p></a></div>
		...
		<!--<div class="row" style="padding-bottom: 25px;">
			...
			<div class="col-xs-4"><a href="/users/edit" style="color:#fff;padding:10px 0;"><span class="glyphicon glyphicon-user" aria-hidden="true" style="font-size:20px;"></span><p style="font-size:13px;">Edit Profile</p></a></div>
			<div class="col-xs-4"><a href="/help" style="color:#fff;padding:10px 0;"><span class="glyphicon glyphicon-question-sign" aria-hidden="true" style="font-size:20px;"></span><p style="font-size:13px;">Help</p></a></div>			
			<div class="col-xs-4"><a href="/users/logout" style="color:#fff;padding:10px 0;"><span class="glyphicon glyphicon-log-out" aria-hidden="true" style="font-size:20px;"></span><p style="font-size:13px;">Sign Out</p></a></div>
...
<li class="dropdown">
<button class="dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Dropdown<span class="caret"></span></button>
