        ...
        <div class="account">
            ...
            <div class="rounded" id="message">
                <div class="col-xs-12 col-sm-6" style="text-align: center;">
                    <p >You have <span><?php echo $unpaidAuctions; ?></span> unpaid auction(s)</p>
                </div>
                <div class="clearfix visible-xs visible-sm" style="margin-bottom:10px;"></div>
                <div class="col-xs-12 col-sm-6" style="text-align: center;">
                    <p>You have <span><?php echo $bidBalance; ?></span>
                        bid <?php if ($bidBalance <= 1): ?>credit<?php else: ?>credits<?php endif; ?> in your account</p>
                </div>
            </div>
            ...
            <?php if ($purchasedBefore == false) : ?>
                <div class="inner">
                    <h3 style="text-align:center;">New to the site?</h3>
                    <ul>
            ...
            <div class="inner">
                <h3 style="text-align:center;">Your Membership Rank</h3>
                <?php
            ...
            <div class="inner">
                <h3 style="text-align:center;">Your Accumulated Bid Points</h3>
                <?php
                if (!empty($bidPoints)) {
            ...
            <div class="inner" style="border-bottom:none;padding-bottom:0;">
                ...
                <?php if (!empty($auctions)): ?>
                    <div class="table-responsive visible-lg visible-md" style="display: table;width:100%;">
                        <table class="default-table table table-condensed table-striped"  width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            foreach ($auctions as $auction): ?>
                                <tr class="auction-item" title="<?php echo $auction['Auction']['id']; ?>"
                                    ...
                                    <td>
                                        ...
                                        <?php else : ?>
                                            <div id="timer_<?php echo $auction['Auction']['id']; ?>"
                                                 class="bid-status countdown"
                                                 title="<?php echo $auction['Auction']['end_time']; ?>">--:--:--
                                            </div>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                    ...
                    <div class="table-responsive visible-sm visible-xs" style="display: table;width:100%;">
                        <table class="default-table table table-condensed table-striped"  width="100%" border="0" cellspacing="0" cellpadding="0">
                            <?php
                            $i = 0;
                            foreach ($auctions as $auction): ?>
