<div class="inner rounded">
    ...
    <p role="button" class="visible-sm visible-xs dropdown-info-down" data-toggle="collapse" href="#collapseAccount" aria-expanded="false"
       aria-controls="collapseAccount" style="float:left;width: 100%;">
        My Account
        <span class="glyphicon glyphicon-menu-down right" aria-hidden="true" style="margin:5px 0 0 10px;float:right;"></span>
    </p>
    <p role="button" class="visible-md visible-lg" data-toggle="collapse" aria-expanded="true">My Account</p>

    <div class="collapse in" id="collapseAccount">
        <ul>
...
<div class="inner rounded">
    <p role="button" class="visible-sm visible-xs dropdown-info-down" data-toggle="collapse" href="#collapseDetails" aria-expanded="false"
       aria-controls="collapseDetails" style="float:left;width: 100%;">
        My Details
        <span class="glyphicon glyphicon-menu-down right" aria-hidden="true" style="margin:5px 0 0 10px;float:right;"></span>
    </p>
    <p role="button" class="visible-md visible-lg" data-toggle="collapse" aria-expanded="true">My Details</p>
