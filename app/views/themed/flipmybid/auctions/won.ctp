        ...
        <div class="account">
            ...
            <?php if (!empty($auctions)): ?>
                ...
                <div class="visible-sm visible-xs">
                    <table class="default-table table table-striped" width="100%" border="0" cellspacing="0" cellpadding="0">
                        <?php
                        $i = 0;
                        foreach ($auctions as $auction):
                            $class = null;
                            ...
                            <tr <?php echo $class; ?>>
                                <td>
                                    <b><?php echo $html->link($auction['Product']['title'], array('controller' => 'auctions', 'action' => 'view', $auction['Auction']['id'])); ?></b>
                                    <br/>
                                    <a href="/auction/<?php echo $auction['Auction']['id']; ?>">
                                        <?php if (!empty($auction['Product']['Image'][0]['image'])): ?>
                                            <?php echo $html->image('product_images/thumbs/' . $auction['Product']['Image'][0]['image']); ?>
