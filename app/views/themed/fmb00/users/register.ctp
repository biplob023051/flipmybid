<div class="col-md-12 auctions">
	<div class="">
	<h2 style="margin: 9px 20px;">Register for Free... and in less than 1 minute!</h2>
	</div>
...
<?php echo $form->create('User', array('action' => 'register', 'class'=>'form-horizontal'));?>
		...
		<div class="col-md-6">
			...
			<div class="col-sm-offset-2 col-sm-10">
				<button type="submit" class="btn btn-register" style="padding:12px !important;width:250px !important;">Register</button>
			</div>
			</div>			
		</div>
	<?php echo $form->end(); ?>
