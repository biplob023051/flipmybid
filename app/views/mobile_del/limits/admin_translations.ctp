...
$html->addCrumb(__('Translations', true), '/admin/limits/translations/'.$limit['Limit']['id']);
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			echo $html->link(__('Edit Translation', true), array('action'=>'edit', $limit['Limit']['id'], $language['Language']['code'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
