...
<?php if(!empty($users)):
	$enabledBidButler = $this->requestAction('/settings/enabled/bid_butler');
	$enabledRewardPoints = $this->requestAction('/settings/enabled/reward_points');
	$enabledWinLimits = $this->requestAction('/settings/enabled/win_limits');
	$enabledReferrals = $this->requestAction('/settings/enabled/referrals')
?>
...
<tr>
	...
	<?php if($enabledMemberships = $this->requestAction('/settings/enabled/memberships')) : ?>
		<th><?php echo $paginator->sort(__('Membership', true), 'Membership.name');?></th>
	<?php endif; ?>
	<th><?php echo $paginator->sort('ip');?></th>
	<?php if($enabledNewsletter =  $this->requestAction('/settings/enabled/newsletter')) : ?>
		<th><?php echo $paginator->sort('newsletter');?></th>
	<?php endif; ?>
	<?php if($getRegisterOption = $this->requestAction('/settings/get/registration_options')) : ?>
...
?>
	<tr<?php echo $class;?>>
		...
		<?php if($enabledMemberships == true) : ?>
		...
		<td>
			<?php if(!empty($user['User']['ip'])):?>
				...
				<?php $location = '';  if(empty($location)) : ?>
