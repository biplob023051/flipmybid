...
<?php if(!empty($newsletterRunning)) : ?>
	<p><strong>There is a newsletter running at the moment.  The newsletter still has <?php echo $newsletterRunning; ?> emails to send.  It is recommended that you to NOT send another newsletter yet.  If you need to stop this newsletter from sending <a href="/admin/newsletters/stop">click here</a>.</strong></p>
<?php endif; ?>
