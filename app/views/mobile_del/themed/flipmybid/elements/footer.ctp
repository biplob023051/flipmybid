<div id="footer">
	<div id="footer-inner">
		<div class="g3">
            ...
            <a target="_blank" href="http://www.youtube.com/FlipMyBid"><?php echo $html->image('icon-youtube.jpg', array('width'=>'56px', 'height'=>'50px', 'alt'=>'YouTube')); ?></a></div>
...
<div id="copyright">
	...
	<p><a target="_blank" href="http://www.instantssl.com"><img src="/theme/flipmybid/img/comodo_secure_76x26_transp.png" alt="SSL Certificates" width="76" height="26" style="border: 0px;"></a>
