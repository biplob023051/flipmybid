<div id="nav">
    <ul class="sf-menu">
        <li><?php echo $html->link(__('Home', true), array('controller' => 'dashboards', 'action' => 'index'), array('class'=>'navs'));?></li>
        <li><?php echo $html->link(__('Manage Auctions', true), array('controller' => 'auctions', 'action' => 'index'), array('class'=>'navs drops'));?>
            <ul>
        ...
        <li><?php echo $html->link(__('Manage Content', true), array('controller' => 'pages', 'action' => 'index'), array('class'=>'navs drops'));?>
            <ul>
        ...
        <li><?php echo $html->link(__('Manage Users', true), array('controller' => 'users', 'action' => 'index'), array('class'=>'navs drops'));?>
            <ul>
        ...
        <?php if($this->requestAction('/settings/enabled/newsletters')) : ?>
        	<li><?php echo $html->link(__('Manage Newsletters', true), array('controller' => 'newsletters', 'action' => 'index'), array('class'=>'navs'));?></li>
        <?php endif; ?>
        <li><?php echo $html->link(__('Settings', true), array('controller' => 'settings', 'action' => 'index'), array('class'=>'navs drops'));?>
            <ul>
				...
				<li><?php echo $html->link(__('Buy It Packages', true), array('controller' => 'buy_it_packages', 'action' => 'index/page:1/sort:created/direction:desc'));?></li>
				<!-- End Change -->
