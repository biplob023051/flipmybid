...
<div class="g6 rounded">
    ...
    <!-- SET THIS -->
    <a href="/rewards/redeem/<?php echo $product['Product']['id']; ?>" class="bidbutton bidbuttonsidebar">Redeem Reward</a>

    <?php if(!empty($product['Product']['rrp'])) : ?>
    	<p>&nbsp;</p>
		<h2><?php __('Worth up to');?>: <?php echo $number->currency($product['Product']['rrp'], $appConfigurations['currency']); ?> </h2>
	<?php endif; ?>
