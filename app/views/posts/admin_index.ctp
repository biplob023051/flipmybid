                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td>
                            <?php if (!empty($post['Post']['title'])) : ?>
                                <strong><?php __('Thread:'); ?></strong> <a target="_blank"
                                                                            href="/posts/view/<?php echo $post['Post']['id']; ?>"><?php echo $post['Post']['title']; ?></a>
                            <?php else : ?>
                                <?php $thread = $this->requestAction('/posts/getthread/' . $post['Post']['post_id']); ?>
                                <a target="_blank"
                                   href="/posts/view/<?php echo $post['Post']['post_id']; ?>"><?php echo $thread['Post']['title']; ?></a>
                            <?php endif; ?>
                        </td>
