...
$html->addCrumb(__('Translations', true), '/admin/categories/translations/'.$membership['Membership']['id']);
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			echo $html->link(__('Edit Translation', true), array('action'=>'edit', $membership['Membership']['id'], $language['Language']['code'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
