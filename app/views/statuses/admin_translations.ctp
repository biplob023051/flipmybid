...
$html->addCrumb(__('Translations', true), '/admin/status/translations/'.$status['Status']['id']);
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			echo $html->link(__('Edit Translation', true), array('action'=>'edit', $status['Status']['id'], $language['Language']['code'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
