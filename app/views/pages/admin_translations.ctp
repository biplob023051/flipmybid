...
$html->addCrumb(__('Translations', true), '/admin/pages/translations/'.$page['Page']['id']);
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			echo $html->link(__('Edit Translation', true), array('action'=>'edit', $page['Page']['id'], $language['Language']['code'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
