                ...
                <tr<?php echo $class; ?>>
                    <td>
                        ...
                        <?php if (!empty($module['Module']['description'])) : ?>
                            <a alt="<?php echo addslashes($module['Module']['description']); ?>"
                               title="<?php echo addslashes($module['Module']['description']); ?>"><?php echo Inflector::humanize($module['Module']['name']); ?></a>
                        <?php else : ?>
