...
$html->addCrumb(__('Translations', true), '/admin/countries/translations/'.$country['Country']['id']);
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			echo $html->link(__('Edit Translation', true), array('action'=>'edit', $country['Country']['id'], $language['Language']['code'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
